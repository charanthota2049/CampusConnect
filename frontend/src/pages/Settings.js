  ...
  return (
    <div className="settings-page">
      ...
      <div className="settings-sections">
        ...
        <SettingsCard title="Notifications" description="Choose how you receive event and notice alerts." isOpen={openSection === 'notifications'} onClick={() => toggleSection('notifications')}>
