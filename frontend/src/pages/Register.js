                ...
                <div className="details">
                    ...
                    <div className="input-group">
                        <input
                            ...
                            name="password" className="password" placeholder="Password"
                    ...
                    <div className="input-group">
                        <input
                            type={toogleConfirmP ? "password" : "text"}
                            name="confirmP" className="password" placeholder="Confirm Password"
                            value={formData.confirmP} onChange={handleFormChange}
                        />
